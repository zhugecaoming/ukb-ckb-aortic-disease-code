...
### Code availability
The analysis code used for the Mendelian randomization workflow is available in this GitHub repository.

### Data availability
The GWAS summary statistics used as input are not redistributed in this repository. Users should obtain the relevant summary statistics from the original data providers and place them into the configured input directories before running the code.

## Notes

This repository is a cleaned template derived from the original project script and is intended for transparent sharing and reuse.  
Because the original data files and local environment are not included here, you should run and validate the workflow locally with your own input data before public release.
