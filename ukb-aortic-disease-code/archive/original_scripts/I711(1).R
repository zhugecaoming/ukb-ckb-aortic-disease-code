...
df <- read_excel("C:/Users/余00/Desktop/Multimorbidity/data/OPCS4_I711.xlsx")
...
merge2$I711_date <- as.Date(merge2$I711_date)
merge2$I712_date <- as.Date(merge2$I712_date)
merge2$AN_date <- pmin(merge2$I711_date,merge2$I712_date,merge2$date,
...
merge2$AN[merge2$I711==1|merge2$I712==1|merge2$death_cause==1|merge2$case==1] <- "1"
...
# 若需保存
write.csv(PAR_table,file="C:/Users/余00/Desktop/PAF_I711.csv", row.names = FALSE)
