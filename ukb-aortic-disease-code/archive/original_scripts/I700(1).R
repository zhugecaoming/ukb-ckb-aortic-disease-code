...
for (i in 2:260) {
  Outcome[, i][grepl("I700", Outcome[, i])] <- 1
...
Outcome$I700 <- 0
Outcome$I700 <- rowSums(Outcome[,c(2:260)], na.rm = FALSE, dims = 1)
table(Outcome$I700)
Outcome$I700[Outcome$I700 >= 1] <- 1
table(Outcome$I700)
Outcome$I700_date <- 20000
Outcome$I700_date <-apply(Outcome[,c(261:519)], 1, FUN=min)
summary(Outcome$I700_date)
Outcome$I700_date <- as.Date(Outcome$I700_date)
Outcome$I700_date[Outcome$I700_date == "2024-10-04"] <- "2023-10-30"  ## 
Disease <- select(Outcome,eid,I700,I700_date)

merge1 <- merge(ukb,death,by='eid')
merge2 <- merge(merge1,Disease,by='eid')
...
# 若需保存
write.csv(PAR_table,file="C:/Users/余00/Desktop/I700.csv", row.names = FALSE)

"hyp","cancer","asthma", "dyspepsia", "CHD", "thy", 
"RA","stroke", "osteoporosis", "COPD", 
"migraine","IBS",  "DDI", "AF", "bronch", "CFS", "PVD",
"CKD", "CLD", "HF", "AP", "TC"